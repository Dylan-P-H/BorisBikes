...
describe DockingStation do
  ...
  it "should be able to dock" do
    bike = Bike.new
    expect(DockingStation.new.store_bike).to eq(bike)
  end
  ...
  describe '#store_bike' do
    it "should raise error when method in full" do
      bike = Bike.new
      station = DockingStation.new
      expect { station.store_bike Bike.new }.to raise_error("Docking Station is full")
    end
  end
end